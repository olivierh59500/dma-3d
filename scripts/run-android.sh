...
go run github.com/hajimehoshi/ebiten/v2/cmd/ebitenmobile@v2.9.11 \
    ...
    -androidapi 23 \
    -javapkg com.olivierh.dma3d \
    -o android/app/libs/dma3d.aar \
    "$mobile_package"
...
echo "→ Lancement de DMA 3D Demo"
$adb_path shell am force-stop com.olivierh.dma3d
$adb_path shell am start -n com.olivierh.dma3d/.MainActivity
